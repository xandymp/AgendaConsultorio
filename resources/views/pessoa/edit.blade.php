        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form action="{{ url('pessoa/'.$data->id) }}" method="post">
                        <div class="card-body">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input id="data_nascimento"
                                       ...
                                       value="{{ old('data_nascimento', $data->data_nascimento) }}"
                            ...
                            <div class="form-group">
                                ...
                                <select id="tipo" name="tipo" class="form-control" required>
                                    ...
                                    <option value="0"{{ old('tipo', $data->tipo) == '0' ? ' selected' : ''}}>Paciente</option>
                                    <option value="1"{{ old('tipo', $data->tipo) == '1' ? ' selected' : ''}}>Medico</option>
                                </select>
